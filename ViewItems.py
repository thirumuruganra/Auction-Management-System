...
def viewitems():
    ...
    headingLabel = Label(headingFrame1, text="View Items Details", bg='black', fg='white', font=('Courier', 15))
    ...
    try:
        ...
        #Old cmd
        for i in data:
            Label(labelFrame, text=" {} \t\t  {} \t\t    {}\t\t\t      {}".format(i[0], i[1], i[2], i[3]), bg='black',fg='white').place(relx=0.07, rely=y)
            y += 0.1
        '''
    except:
